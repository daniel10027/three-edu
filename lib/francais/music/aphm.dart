...
void main() => runApp(Alphamusicfr());

class Alphamusicfr extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<Alphamusicfr> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("L'Alphabet en Musique"),
          centerTitle: true,
        ),
        body: Padding(
